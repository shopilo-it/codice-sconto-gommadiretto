#!/usr/bin/env python3
"""
Recupero codici sconto Gommadiretto da shopilo.it
Sursa: https://shopilo.it/negozi/gommadiretto.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/gommadiretto.it"
STORE_NAME = "Gommadiretto"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Gommadiretto da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-gommadiretto)"
    }
    try:
